...
image_icon=PhotoImage(file="google logo.png")
...
text1=Text(f,font="Roboto 30",bg="white",relief=GROOVE,wrap=WORD)
...
text2=Text(f1,font="Roboto 30",bg="white",relief=GROOVE,wrap=WORD)
